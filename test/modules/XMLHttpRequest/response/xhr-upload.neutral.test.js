...
import { spyOnXMLHttpRequest, spyOnXMLHttpRequestUpload, waitForXMLHttpRequest, } from '#/test/setup/helpers-neutral';
...
it('intercepts a bypassed request with the upload listeners', async ({ task, }) => {
...
it('fires the upload events for a mocked request', async ({ task }) => {
    interceptor.on('request', ({ request, controller }) => {
        controller.respondWith(new Response(request.body, {
            headers: {
