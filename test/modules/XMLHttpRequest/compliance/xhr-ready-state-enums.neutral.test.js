...
const IS_HAPPY_DOM = typeof window !== 'undefined' && 'happyDOM' in window;
...
/**
 * @note Happy DOM does not define the ready state enums
 * on the XMLHttpRequest prototype, only as static properties.
 */
it.skipIf(IS_HAPPY_DOM)('exposes ready state enums as instance-level properties', () => {
