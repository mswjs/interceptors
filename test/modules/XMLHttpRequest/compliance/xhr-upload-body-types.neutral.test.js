...
import { spyOnXMLHttpRequestUpload, waitForXMLHttpRequest, } from '#/test/setup/helpers-neutral';
...
it.for(uploadScenarios)('supports uploading %s to the original server', async ([, createBody, totalBytes], { task }) => {
...
it.for(uploadScenarios)('supports uploading %s to a mocked server', async ([, createBody, totalBytes], { task }) => {
