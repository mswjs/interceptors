...
it('sets the "url" property to the passed URL', () => {
    expect(new WebSocket('wss://example.com')).toHaveProperty('url', 'wss://example.com/');
    expect(new WebSocket(new URL('wss://example.com'))).toHaveProperty('url', 'wss://example.com/');
    expect(new WebSocket('ws://example.com')).toHaveProperty('url', 'ws://example.com/');
    expect(new WebSocket(new URL('ws://example.com'))).toHaveProperty('url', 'ws://example.com/');
});
...
it('sets the "binaryType" to "blob" by default', () => {
    expect(new WebSocket('wss://example.com')).toHaveProperty('binaryType', 'blob');
});
