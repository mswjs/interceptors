...
it('supports a custom HTTPS agent that assigns the socket certificate', async () => {
    ...
    expect(agent.certificate).toEqual(expect.objectContaining({
        fingerprint: 'AC:E6:F1:6B:7A:41:2D:3F:13:E2:64:81:29:C3:4F:94:B1:A5:34:E6',
