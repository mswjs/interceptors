  ...
  describe('POST', () => {
    ...
    it('supports POST request with query parameter', async () => {
      await assertQueryParameter(
        ...
        createRequest({
          using: http.request,
          url: 'http://httpbin.org/post/query?userId=abc',
          options: {
            method: 'POST',
          },
        }),
    ...
    it('supports POST request with body', async () => {
      const request = createRequest({
        using: http.request,
        url: 'http://httpbin.org/post/body',
        options: {
          method: 'POST',
        },
      })
  ...
  describe('PUT', () => {
    ...
    it('supports PUT request with headers', async () => {
      await assertHeaders(
        ...
        createRequest({
          using: http.request,
          url: 'http://httpbin.org/put/headers',
          options: {
            method: 'PUT',
            headers: {
              'x-custom-header': 'true',
    ...
    it('supports PUT request with query parameter', async () => {
      await assertQueryParameter(
        ...
        createRequest({
          using: http.request,
          url: 'http://httpbin.org/put/query?userId=abc',
          options: {
            method: 'PUT',
          },
        }),
  ...
  describe('PATCH', () => {
    ...
    it('supports PATCH request with headers', async () => {
      await assertHeaders(
        ...
        createRequest({
          using: http.request,
          url: 'http://httpbin.org/patch/headers',
          options: {
            method: 'PATCH',
            headers: {
              'x-custom-header': 'true',
    ...
    it('supports PATCH request with query parameter', async () => {
      await assertQueryParameter(
        ...
        createRequest({
          using: http.request,
          url: 'http://httpbin.org/patch/query?userId=abc',
          options: {
            method: 'PATCH',
          },
        }),
  ...
  describe('DELETE', () => {
    ...
    it('supports DELETE request with headers', async () => {
      await assertHeaders(
        ...
        createRequest({
          using: http.request,
          url: 'http://httpbin.org/delete/headers',
          options: {
            method: 'DELETE',
            headers: {
              'x-custom-header': 'true',
    ...
    it('supports DELETE request with query parameter', async () => {
      await assertQueryParameter(
        ...
        createRequest({
          using: http.request,
          url: 'http://httpbin.org/delete/query?userId=abc',
          options: {
            method: 'DELETE',
          },
        }),
