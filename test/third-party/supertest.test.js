...
it('intercepts a GET request', async () => {
    ...
    expect(responseFromListener.headers.get('content-type')).toBe('text/plain; charset=utf-8');
...
it('intercepts a POST request', async () => {
    ...
    expect(responseFromListener.status).toBe(200);
    expect(responseFromListener.statusText).toBe('OK');
    expect(responseFromListener.headers.get('content-type')).toBe('application/json; charset=utf-8');
