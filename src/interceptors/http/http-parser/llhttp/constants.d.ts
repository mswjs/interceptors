...
export declare const METHODS_AIRPLAY: Simplify<
  Pick<typeof METHODS_BASIC_HTTP, 'GET' | 'POST'>
>
...
export declare const ALPHA: readonly [
  'A',
  'a',
  'B',
  'b',
...
export declare const DIGIT: readonly [
  '0',
  '1',
  '2',
  '3',
...
export declare const ALPHANUM: readonly [
  'A',
  'a',
  'B',
  'b',
...
export declare const USERINFO_CHARS: readonly [
  'A',
  'a',
  'B',
  'b',
...
export declare const URL_CHAR: readonly [
  '!',
  '"',
  '$',
  '%',
...
export declare const HTAB_SP_VCHAR_OBS_TEXT: readonly [
  '\t',
  ' ',
  33,
  34,
...
export declare const HEADER_CHARS: readonly [
  '\t',
  ' ',
  33,
  34,
...
export declare const RELAXED_HEADER_CHARS: readonly [
  1,
  2,
  3,
  4,
...
export declare const CONNECTION_TOKEN_CHARS: readonly [
  '\t',
  ' ',
  33,
  34,
...
export declare const QDTEXT: readonly [
  '\t',
  ' ',
  33,
  35,
...
declare const _default: {
  ...
  CONNECTION_TOKEN_CHARS: readonly [
    '\t',
    ' ',
    33,
    34,
  ...
  HTAB_SP_VCHAR_OBS_TEXT: readonly [
    '\t',
    ' ',
    33,
    34,
